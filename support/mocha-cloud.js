...
var app = connect(),
  cloud = new Cloud('openxjs', auth.username, auth.key),
...
cloud.browser('chrome', null, 'Windows 2008');
// cloud.browser('chrome', null, 'Linux');

/*!
 * Firefox
 */

cloud.browser('firefox', '4', 'Windows 2008');
